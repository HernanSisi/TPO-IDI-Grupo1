...
BEGIN
    ...
    SELECT TOP 1
        @Producto_Default = ID_Producto
    FROM Producto
    WHERE Nombre_Producto LIKE '%Habitacion%';
    ...
    INSERT INTO Gasto
        (Importe, Producto_Gasto, Cantidad_Producto, ID_Personal, ID_Reserva, Origen_Gasto)
    SELECT
